...
class GestionRutas {
    fun obtenerPedidos(callback: (List<Pedido>) -> Unit) {
        ...
        val pedidosList = listOf(
            Pedido("1", "Pedido 1", "Pendiente", "Cliente 1", "Ubicación 1", "10", "1"),
            Pedido("2", "Pedido 2", "Entregado", "Cliente 2", "Ubicación 2", "5", "2"),
            Pedido("3", "Pedido 3", "Pendiente", "Cliente 3", "Ubicación 3", "8", "3")
        )
